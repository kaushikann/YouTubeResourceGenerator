...
st.subheader("This tool will help new YouTube content creators to generate all the resources required for creating their first YouTube videos. The output will have Text Content, Audio File, Competitor Analysis, Thumbnail and MCQs on the topic. This video generator is focused on CBSE topics.")
